			...
			<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
				<div class="column">
					...
					<p>
						...
						<input min="1" type="number" name="eage" value="<?php echo $row[4]; ?>">
					</p>
					<p>
				...
				<div class="column">
					...
					<p>
						...
						<input type="number" step="0.01" name="esal" min = "1" value="<?php echo $row[8]; ?>">
					</p>
					<p>
						<label for="ephno">Phone Number:</label><br>
						<input type="number" name="ephno" min = "1" value="<?php echo $row[9]; ?>">
					</p>
					
					<p>
						<label for="e_mail">Email ID:</label><br>
						<input type="mail" name="e_mail"  value="<?php echo $row[10]; ?>">
					</p>
					<p>
