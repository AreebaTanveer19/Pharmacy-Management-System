			...
			<form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
				<div class="column">
					...
					<p>
						...
						<input type="number" name="pqty" min="1" value="<?php echo $row[3]; ?>">
					</p>
				</div>
				...
				<div class="column">
					<p>
						...
						<input type="number" step="1" name="pcost" min="1" value="<?php echo $row[4]; ?>">
					</p>
...
if (isset($_POST['update'])) {
	...
	if ($pdate > $edate || $edate < $mdate || $pdate < $mdate) {
		echo "<p style='color: red; font-weight: bold;text-align: center;margin-left : 250px; font-size: 25px;'>INVALID DATES!</p>";
	} else {
