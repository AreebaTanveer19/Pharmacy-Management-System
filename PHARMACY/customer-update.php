...
<body>
	...
	<?php
		...
		echo "<p style='font-size:8; color:red;'>Error! Enter Valid Age.</p>";}}
			...
			<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
				<div class="column">
					...
					<p>
						...
						<input min="1" type="number" name="age" value="<?php echo $row[3]; ?>">
					</p>
				...
				<div class="column">
					...
					<p>
						...
						<input type="email" name="emid" style="width: 80%;padding: 12px;border: 1px solid #ccc;border-radius: 4px;" value="<?php echo $row[6]; ?>">
					</p>
				</div>
